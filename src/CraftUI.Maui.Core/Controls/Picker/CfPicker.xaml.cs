...
public partial class CfPicker
{
    ...
    public CfPicker()
    {
        ...
        Element.SetBinding(Microsoft.Maui.Controls.Picker.ItemsSourceProperty, nameof(ItemsSource));
        Element.SetBinding(Microsoft.Maui.Controls.Picker.SelectedItemProperty, nameof(SelectedItem));
